...
def Init_Indicateurs(d):
    ...
    MpotH["somme"] = [] * ( d["temps"] - 3 ) #On crée une liste qui sera la somme des pot. sur chaque période
...
def Remplir_Indicateurs(d, df, MpotH, NbrMaint, t):
    ...
    for a in d["listeAvion"]:
        MpotH["somme"][t] += MpotH[a][t] # On fait la somme des pot. sur tous les avions à chaque période
